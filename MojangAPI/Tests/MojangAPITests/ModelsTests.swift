...
final class ModelsTests: XCTestCase {
    ...
    func testPlayerProfile_Creation() {
        ...
        // Act
        let profile = PlayerProfile(id: uuid, name: name, skins: skins, capes: capes)
    ...
    func testPlayerProfile_WithSkinAndCape() {
        // Arrange
        let uuid = UUID()
        let skinURL = URL(string: "http://textures.minecraft.net/texture/1234567890")!
        let capeURL = URL(string: "http://textures.minecraft.net/texture/0987654321")!
    ...
    func testPlayerUUIDResponse_Decoding() throws {
        ...
        XCTAssertEqual(response.id.uuidString.lowercased(), "069a79f4-44e9-405c-98c9-d58ab183bfe9")
    }
    ...
    func testSessionProfile_WithProperties() {
        ...
        let id = "069a79f4-44e9-405c-98c9-d58ab183bfe9"
        let name = "Steve"
        let property = ProfileProperty(name: "textures", value: "base64-encoded-value")
    ...
    func testProfileProperty_Creation() {
        ...
        // Act
        let property = ProfileProperty(name: name, value: value, signature: signature)
