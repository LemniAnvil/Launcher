...
public protocol MojangAPIClientProtocol {
  func request<T: Decodable>(_ endpoint: MojangEndpoint, body: Encodable?)
    async throws -> T
  func request(_ endpoint: MojangEndpoint, body: Encodable?) async throws
    -> Data
}
...
public class MojangAPIClient: MojangAPIClientProtocol {
  ...
  public func request(_ endpoint: MojangEndpoint, body: Encodable? = nil)
    async throws -> Data
  {
