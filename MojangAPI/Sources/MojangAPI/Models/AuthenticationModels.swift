...
public struct MinecraftProfileResponse: Codable {
  public let id: String
  public let name: String
...
/// Skin Information from Minecraft Profile API
...
/// Skin Metadata from Minecraft Profile API
public struct SkinInfoMetadata: Codable {
...
/// Cape Information from Minecraft Profile API
public struct CapeInfo: Codable {
  public let id: String
  public let url: String
  public let state: String
...
// MARK: - Complete Login Response

/// Complete login response with profile and tokens
